...
// Account settings
    ...
    const accounts = [                      
        'ftxmain' =>  [          
            'description'   => 'FTX Main Account',
            'exchange'      => 'ftx',
            'parameters'    =>  [
                'apiKey'    =>  '2GXuRuawet8aJx',
                'secret'    =>  'S3IEP_AdSDRgSDRgGSErR_yGDA',
            ],
            'symbolmap'     =>  [
                'default'   =>  'BTC-PERP',
                'BTCUSD'    =>  'BTC-PERP',
        ...
        'ftxsub' =>  [         
            'description'   => 'FTX Sub Account',
            'exchange'      => 'ftx',
            'parameters'    =>  [
                'apiKey'    =>  '2GXuRuawet8aJx',
                'secret'    =>  'S3IEP_AdSDRgSDRgGSErR_yGDA',
                'headers'   => [
                    'FTX-SUBACCOUNT' => 'MySubAccount' // This is needed if using a subaccount on FTX
                ]
            ],
            'symbolmap'     =>  [
                'default'   =>  'BTC-PERP',
         ...
         ,
        'deribitmain' =>  [
            'description'   => 'Deribit Main Account',
            'exchange'      => 'deribit',
            'parameters'    =>  [
                'apiKey'    =>  '2GXuRuawet8aJx',
                'secret'    =>  'S3IEP_AdSDRgSDRgGSErR_yGDA',
        ...
        'deribittest' =>  [
            'description'   => 'Deribit Test Account',
            'exchange'      => 'deribit',
            'parameters'    =>  [
                'apiKey'    =>  '2GXuRuawet8aJx',
                'secret'    =>  'S3IEP_AdSDRgSDRgGSErR_yGDA',
        ...
        'bitmexmain' =>  [
            'description'   => 'Bitmex Main Account',
            'exchange'      => 'bitmex',
            'parameters'    =>  [
                'apiKey'    =>  '2GXuRuawet8aJx',
                'secret'    =>  'S3IEP_AdSDRgSDRgGSErR_yGDA',
        ...
        'bitmextest' =>  [
            'description'   => 'Bitmex Test Account',
            'exchange'      => 'bitmex',
            'parameters'    =>  [
                'apiKey'    =>  '2GXuRuawet8aJx',
                'secret'    =>  'S3IEP_AdSDRgSDRgGSErR_yGDA',
